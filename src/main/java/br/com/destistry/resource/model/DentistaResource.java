package br.com.dentistry.resource.model;

import java.io.Serializable;

import com.fasterxml.jackson.annotation.JsonProperty;

public class DentistaResource implements Serializable {
  ...
  public String toString() {
    return "DentistaResource [nome=" + nome + ", idade=" + idade + ", codigoRegistro="
